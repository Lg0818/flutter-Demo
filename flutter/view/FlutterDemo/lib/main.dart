...
import 'Components/RadioPage.dart';
import 'Util/AnimatedAction.dart';
...
class MyApp extends StatelessWidget {
  ...
  bool onInActiveView(context) {
    print('USBAudioUI : recive USBAudioUI onInActiveView from AppBase');
    Navigator.pop(context);
    print('USBAudioUI : USBAudioUI Hide');

    print('USBAudioUI : return USBAudioUI onInActiveView  to AppBase');
    final appBase = AppBase();
    appBase.resInactiveview();
    appBase.close();
  }
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final IOWebSocketChannel _channel =
      IOWebSocketChannel.connect('ws://localhost:10001');
  @override
  void initState() {
    print('webApp connect ArbitrationManager port: 10001');
    super.initState();
    AppBase().init(context);
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                new GestureDetector(
                  ...
                  onTap: () {
                    print(
                        'USB Audio UI request ArbitrationManager::ArbitrateUiApps');
                    _sendHandle();
                    _channel.sink.close();
                  },
                ),
